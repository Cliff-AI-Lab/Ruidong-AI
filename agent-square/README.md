...
The **industry-specific slice (306 agents across 9 verticals)** lives in the companion repo **[Enterprise-AI-Lab/agent-square](https://github.com/Cliff-AI-Lab/Enterprise-AI-Lab/tree/main/agent-square)**. Together they form the complete **365-agent Agent Square**.
...
**行业专属部分（9 大行业 306 个智能体）** 发布在姐妹仓库 **[Enterprise-AI-Lab/agent-square](https://github.com/Cliff-AI-Lab/Enterprise-AI-Lab/tree/main/agent-square)**。两仓合计即 **完整的 365 智能体广场**。
